  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#1a1a2e] text-white text-3xl font-light flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.45)] hover:bg-[#1a1a2e] active:scale-95 transition-all"
      >
        +
      </button>
