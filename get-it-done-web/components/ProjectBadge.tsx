...
// Secondary visual weight — no dot, no border, just a tinted pill. Non-active
// projects (paused/completed/archived) render faded so stale labels don't
// scream for attention.
export function ProjectBadge({ project }: Props) {
  if (!project) return null;
  const faded = project.status !== 'active';
  return (
    <span
